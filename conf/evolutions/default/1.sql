...
create table if not exists "dokumenty_identyfikacyjne" (
  ...
  foreign key (typ_dokumentu) references public.typy_dokumentu(id));
...
create table if not exists "dane_osobowe" (
  ...
  foreign key (dokument_identyfikacyjny) references public.dokumenty_identyfikacyjne(id));
...
create table if not exists "decyzje" (
  ...
  foreign key (wydajacy) references public.pracownicy(id));
...
create table if not exists "przesylki" (
  ...
  foreign key (placowka) references public.placowki(id));
...
create table if not exists "sprawy" (
  ...
  "przesylka" BIGINT,
  foreign key (dane_osobowe) references public.dane_osobowe(id),
  foreign key (aktualna_decyzja) references public.decyzje(id),
  foreign key (przesylka) references public.przesylki(id));
